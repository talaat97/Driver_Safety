                ...
                BlocConsumer<HomeCubit, HomeStates>(
                  ...
                  builder: (context, state) {
                     if(HomeCubit.get(context).userModel!=null){
                      _nameController1.text = HomeCubit.get(context).userModel!.firstContactModel!.name!;
                      _phoneController1.text = HomeCubit.get(context).userModel!.firstContactModel!.phone!;
                        _nameController2.text = HomeCubit.get(context).userModel!.secondContactModel!.name!;
                        _phoneController2.text = HomeCubit.get(context).userModel!.secondContactModel!.phone!;
                    return Expanded(
                      ...
                      Padding(
                        ...
                        child: FormButton(
                          ...
                          onPressed: () {
                            ...
                            {
                              ContactsCubit.get(context).firstContact = ContactModel(
                                phone: _phoneController1.text, name: _nameController1.text);
                              ContactsCubit.get(context).secondContact = ContactModel(
                                phone: _phoneController2.text, name: _nameController2.text);
                              Get.back();
                              HomeNavCubit.get(context).changeIndex(newIndex: 3);
                            }
                          },
                        ),
                      ),
